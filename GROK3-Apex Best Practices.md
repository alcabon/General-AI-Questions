Salesforce Coding Best Practices Guide
...
Non-compliant Example:String query = 'SELECT Id FROM Contact WHERE Email = \'' + userInput + '\'';


Compliant Example:String query = 'SELECT Id FROM Contact WHERE Email = :userInput';
...
Non-compliant Example:// 2000-line class with multiple responsibilities
public class LargeClass { ... }


Compliant Example:// Split into smaller, focused classes
...
Non-compliant Example:<input type="password" name="pwd">


Compliant Example:<input type="password" name="pwd" autocomplete="off">
...
Non-compliant Example:<apex:outputText value="{!data}" escape="false"/>


Compliant Example:<apex:outputText value="{!JSENCODE(data)}"/>
...
Non-compliant Example:<apex:page apiVersion="28.0">


Compliant Example:<apex:page apiVersion="59.0">
...
Non-compliant Example:// LWC with invalid TypeScript syntax
export default class MyComponent {
    myVar = "string"; // Incorrect type annotation
}


Compliant Example:export default class MyComponent {
...
Non-compliant Example:<script> var sessionId = "{!$API.Session_Id}"; </script>


Compliant Example:<!-- Avoid exposing session ID; use server-side logic -->
...
Non-compliant Example:console.log("Debug info");
...
Non-compliant Example:const password = "secret123";


Compliant Example:const password = process.env.PASSWORD; // Use environment variables
...
Non-compliant Example:let result = condition ? value1 : condition2 ? value2 : value3;


Compliant Example:let result;
if (condition) {
    result = value1;
} else if (condition2) {
    result = value2;
...
Non-compliant Example:<userPermissions>
    <enabled>true</enabled>
    <name>ModifyAllData</name>
</userPermissions>


Compliant Example:<userPermissions>
...
Non-compliant Example:<!-- Flow with 50+ nodes -->


Compliant Example:<!-- Break into smaller sub-flows -->
...
Non-compliant Example:<fullName>flow1</fullName>


Compliant Example:<fullName>Account_Validation_Flow</fullName>
